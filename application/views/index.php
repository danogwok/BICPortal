        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center"><div class="text-center"><img src="<?php echo base_url(); ?>assets/Images/Eskom.jpg" style="width:280px;height:80px;">
                  ...
                  <form class="user" action="<?php echo base_url(); ?>user/login" method="post">
                    ...
                    <button class="btn btn-primary btn-user btn-block" type="submit" name="action">
                      Login
                    </button>
                    <hr>
                    <a href ="<?php echo base_url(); ?>user/load_Register" class="btn btn-google btn-user btn-block">
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url(); ?>user/load_Register">Create an Account!</a>
                  </div>
                </div>
              </div>
            </div>
